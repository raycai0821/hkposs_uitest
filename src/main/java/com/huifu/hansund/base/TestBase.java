package com.huifu.hansund.base;
...
public class TestBase {
    ...
    public static void init() {
        ...
        if ("chrome".equals(browserName)) {
            System.setProperty("webdriver.chrome.driver", "src\\main\\resources\\driver\\win\\chromedriver.exe");
            driver = new ChromeDriver();
        } else if ("firefox".equals(browserName)) {
            System.setProperty("webdriver.chrome.driver", "src\\main\\resources\\driver\\win\\firefox.exe");
